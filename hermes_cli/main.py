...
def _configure_windows_stdio() -> None:
    """Prefer UTF-8 stdio on Windows so Unicode CLI output does not crash."""
    if os.name != "nt":
        return
...
def cmd_profile(args):
    ...
    if action == "list":
                ...
                if collision:
                    ...
                    if wrapper_path:
                        ...
                        if not _is_wrapper_dir_in_path():
                            ...
                            if os.name == "nt":
                                print("  Add it to your user PATH in Windows Environment Variables.")
                            else:
        ...
        from hermes_cli.profiles import _get_wrapper_path
        ...
        if remove:
            ...
            if wrapper_path:
                ...
                if custom_name:
                    from hermes_cli.profiles import _wrapper_contents
